...
using MyErp.DAL.Core;
using MyErp.DAL.Core.Interfaces;
    ...
    public class DatabaseInitializer : IDatabaseInitializer
    {
        ...
        public async Task SeedAsync()
        {
            ...
            if (!await _context.Users.AnyAsync())
            {
                ...
                await CreateUserAsync("admin", "tempP@ss123", "Inbuilt Administrator", "nthanhtrung269@gmail.com", "", new string[] { adminRoleName });
                await CreateUserAsync("user", "tempP@ss123", "Inbuilt Standard User", "nthanhtrung269@gmail.com", "", new string[] { userRoleName });
            ...
            if (!await _context.Customers.AnyAsync() && !await _context.ProductCategories.AnyAsync())
            {
                ...
                Customer cust_1 = new Customer
                {
                    ...
                    Email = "contact@nguyenthanhtrung.net",
                    Gender = Gender.Male,
