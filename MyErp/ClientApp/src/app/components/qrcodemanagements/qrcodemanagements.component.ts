...
@Component({
  selector: 'settings',
  templateUrl: './qrcodemanagements.component.html',
  styleUrls: ['./qrcodemanagements.component.scss'],
  animations: [fadeInOut]
})
export class QrCodeManagementsComponent implements OnInit, OnDestroy {
